      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            Давайте <span className="text-primary">создадим праздник</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Расскажите о вашем событии — мы свяжемся с вами и предложим идеи для незабываемого праздника. Консультация бесплатна.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <Card className="border-none shadow-xl bg-background">
              <CardHeader>
                <CardTitle className="text-2xl">Расскажите о вашем празднике</CardTitle>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={handleChange}
                      placeholder="Какой повод, дата, количество гостей и пожелания..."
                      rows={6}
                      required
                      className="transition-all focus:scale-[1.02]"
                    />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      <br />
                      Праздники проводим без выходных
                    </p>
                  </div>
                </div>
              </CardContent>
